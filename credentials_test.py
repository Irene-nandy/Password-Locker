...
class TestCredentials(unittest.TestCase):
    def setUp(self):
        self.new_credentials = Credentials("status","Irene","2020","irene@g.com")
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_credentials.name,"Irene")
        self.assertEqual(self.new_credentials.password,"2020")
        self.assertEqual(self.new_credentials.email, "irene@g.com")
    ...
    def test_save_multiple_credentials(self):
        ...
        """
        self.new_credentials.save_credentials()
        test_credentials = Credentials("status","Irene","2020","irene@g.com")
    ...
    def test_credentials_exists(self):
        ...
        self.new_credentials.save_credentials()
        test_credentials = Credentials("status","Irene","2020","irene@g.com") #create new account
        test_credentials.save_credentials()

        credentials_exists = Credentials.credentials_exist("2020")
